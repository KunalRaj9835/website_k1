      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-gray-600 text-lg mb-6">
                Keptel was conceptualized with indigenous and unparalleled thought of redefining the human resource industry and addressing talent enigma with the Tech & Touch initiative.
              </p>
              <p className="text-gray-600 text-lg">
                Keptel has set a new benchmark in the competitive world of talent acquisition through its assiduously conceptualized talent services. We examine macro to micro aspect of your business to perform precise research in order to create a sustainable inflow of suitable talents in your organisation.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24">
          ...
          <p className="text-gray-600 text-lg text-center max-w-4xl mx-auto mb-6">
            At Keptel, our journey has gradually allowed us to provide an entire range of talent services that thoroughly supports our client's talent requirements.
          </p>
          
          <p className="text-gray-600 text-lg text-center max-w-4xl mx-auto mb-12">
            Withstanding the uncertain limitation levied by the year 2025, cohesive efforts made by Keptel to remain undeterred and focused on organisational goals yielded astounding outcomes. We added successive CoE (Center of Excellence) year after year to provide customized talent solution that fits every client's talent needs.
          </p>
