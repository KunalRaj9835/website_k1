    ...
    <div className="w-full bg-white text-gray-900">
      ...
      <section className="w-full bg-white py-20">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="border-l-4 border-red-500 pl-4 mb-10">
            <h2 className="text-2xl font-extralight">
              How Keptel Powers Healthcare Digital Transformation
            </h2>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-lg font-light">
                Keptel specialists implement FHIR, HL7, DICOM, and integration frameworks to unify patient records
            ...
            <div>
              ...
              <p className="text-lg font-light">
                Keptel sources experts trained in HIPAA, GDPR, encryption, SOC2, intrusion detection,
            ...
            <div>
              ...
              <p className="text-lg font-light">
                Healthcare faces IT talent shortages. Keptel mitigates this through large talent networks,
