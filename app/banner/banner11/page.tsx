    ...
    <div className="w-full bg-white text-gray-900">
      ...
      <section className="w-full bg-[#111827] text-white py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          {/* RIGHT HERO VISUAL - Simple Bar Diagram */}
          <div className="w-full bg-white text-gray-900">
          <AIpipline />
          </div>
        </div>
      ...
      {/* ================= THREE PILLARS ================= */}
      <section className="w-full bg-[#F5F7FB]  text-black py-16 md:py-20 border-t border-slate-800">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-8 text-sm text-gray-700">
              <div className="bg-[#F5F7FB] rounded-xl p-6">
                ...
                <h4 className="font-semibold mb-2 text-base">Clean & Trusted Data</h4>
                <p>
              ...
              <div className="bg-[#F5F7FB] rounded-xl p-6">
                <div className="text-3xl mb-3"></div>
                <h4 className="font-semibold mb-2 text-base">Revenue Generation</h4>
                <p>
              ...
              <div className="bg-[#F5F7FB] rounded-xl p-6">
                <div className="text-3xl mb-3"></div>
                <h4 className="font-semibold mb-2 text-base">AI-Powered Automation</h4>
                <p>
...
function MetricItem({ label, value }: MetricItemProps) {
  return (
    <div className="flex justify-between items-center py-2 border-b border-gray-300 last:border-0">
